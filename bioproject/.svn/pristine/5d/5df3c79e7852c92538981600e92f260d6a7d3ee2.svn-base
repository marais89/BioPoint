...
<% String urlServerSpago = (String) request.getParameter("urlServerSpago"); %>

	<spagobi:execution 
			spagobiContext= "<%= urlServerSpago %>"
			userId="<%= login %>"
			password="<%= password %>"
	        documentId="<%= documentId %>"
	        iframeStyle="height:500px; width:100%; border:0px none !important; overflow:auto !important;minwidth:450px" 
