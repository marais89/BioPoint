...
public class MvtServlet extends HttpServlet implements Serializable{
	/**
	 * 
	 */
...
listmvt=new ArrayList<Mvt>();
		...
		//engine.setStartDate(new Date());
		//.setEndDate(new Date());
		//engine.setListPersonnel(personnelService.findAllWithoutPersonnels());
		//engine.initializePointage();
		timer.scheduleAtFixedRate(task,3000,Integer.valueOf(service.byId("freqlecture").getValueparam()) * 1000 * 60);
